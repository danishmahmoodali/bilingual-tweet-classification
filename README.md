...
📄 **[Read the research paper](docs/Bilingual_Tweet_Classification_Paper.pdf)** — *Labeling & Classification of Bilingual Tweets*. The full B.Sc. thesis is also included ([docs/FYP_Research_Paper.docx](docs/FYP_Research_Paper.docx)).
